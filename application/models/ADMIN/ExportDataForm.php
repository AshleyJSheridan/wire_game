...
class ADMIN_ExportDataForm extends Zend_Form
{
    ...
    public function init()
    {
        ...
        {
            $campaignName = $this->createElement('select', 'campaignName', array('attribs' => array('message' => 'Please select a Competition Campaign Name')));
            $campaignName->setLabel('Select Competition Campaign Name:')->setRequired(true)->addMultiOptions($this->_campaignNames);
